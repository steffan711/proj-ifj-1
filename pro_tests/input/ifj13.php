 ...
 * Pouziti: 
 * 	pripojte tento soubor pred vas program a poslete php
 * 		cat ifj13.php vas_skript.php | php !!! NEPODPORUJE STDIN !!!
 * 	nebo predejte tomuto skriptu nazev vaseho souboru jako jediny parametr
 * 		php ifj13.php vas_skript.php
 * 
 * PHP version 5
 * 
...
function get_string()
{
	...
	if(strlen($line) && $line[strlen($line) - 1] == "\r")//for windows \r\n
		$line = substr($line, 0, strlen($line) - 1);
	return $line;
}
